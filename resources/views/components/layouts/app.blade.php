                            ...
                            <div class="header-action-2">
                                <div class="header-action-icon-2">
                                    <a href="shop-wishlist.php">
                                        <img class="svgInject" alt="Tech Media" src="assets/imgs/theme/icons/icon-heart.svg">
                                        <span class="pro-count blue">4</span>
                                    </a>
                                </div>
                                <div class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="cart.html">
                                        <img alt="Tech Media" src="assets/imgs/theme/icons/icon-cart.svg">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html"><img alt="Tech Media" src="assets/imgs/shop/thumbnail-3.jpg"></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html"><img alt="Tech Media" src="assets/imgs/shop/thumbnail-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                ...
                <div class="header-wrap header-space-between position-relative">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li class="has-children">
                                        <a href="shop.html"><i class="Techmedia-font-dress"></i>Women's Clothing</a>
                                    ...
                                    <li class="has-children">
                                        <a href="shop.html"><i class="Techmedia-font-tshirt"></i>Men's Clothing</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li class="has-children">
                                        <a href="shop.html"><i class="Techmedia-font-smartphone"></i> Cellphones</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li><a href="shop.html"><i class="Techmedia-font-desktop"></i>Computer & Office</a></li>
                                    <li><a href="shop.html"><i class="Techmedia-font-cpu"></i>Consumer Electronics</a></li>
                                    <li><a href="shop.html"><i class="Techmedia-font-diamond"></i>Jewelry & Accessories</a></li>
                                    <li><a href="shop.html"><i class="Techmedia-font-home"></i>Home & Garden</a></li>
                                    <li><a href="shop.html"><i class="Techmedia-font-high-heels"></i>Shoes</a></li>
                                    <li><a href="shop.html"><i class="Techmedia-font-teddy-bear"></i>Mother & Kids</a></li>
                                    <li><a href="shop.html"><i class="Techmedia-font-kite"></i>Outdoor fun</a></li>
                                    <li>
                                        <ul class="more_slide_open" style="display: none;">
                                            <li><a href="shop.html"><i class="Techmedia-font-desktop"></i>Beauty, Health</a></li>
                                            <li><a href="shop.html"><i class="Techmedia-font-cpu"></i>Bags and Shoes</a></li>
                                            <li><a href="shop.html"><i class="Techmedia-font-diamond"></i>Consumer Electronics</a></li>
                                            <li><a href="shop.html"><i class="Techmedia-font-home"></i>Automobiles & Motorcycles</a></li>
                                        </ul>
                                    </li>
                                </ul>
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="product-details.html"><img src="assets/imgs/banner/menu-banner.jpg" alt="Tech Media"></a>
                    ...
                    <div class="header-action-right d-block d-lg-none">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.php">
                                    <img alt="Tech Media" src="assets/imgs/theme/icons/icon-heart.svg">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Tech Media" src="assets/imgs/shop/thumbnail-4.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                <li><a href="shop.html"><i class="Techmedia-font-dress"></i>Women's Clothing</a></li>
                                <li><a href="shop.html"><i class="Techmedia-font-tshirt"></i>Men's Clothing</a></li>
                                <li> <a href="shop.html"><i class="Techmedia-font-smartphone"></i> Cellphones</a></li>
                                <li><a href="shop.html"><i class="Techmedia-font-desktop"></i>Computer & Office</a></li>
                                <li><a href="shop.html"><i class="Techmedia-font-cpu"></i>Consumer Electronics</a></li>
                                <li><a href="shop.html"><i class="Techmedia-font-home"></i>Home & Garden</a></li>
                                <li><a href="shop.html"><i class="Techmedia-font-high-heels"></i>Shoes</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@Techmedia.in
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="mb-0 text-lg-end text-start font-sm text-muted">
                        &copy; <strong class="text-brand">TechMedia</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
